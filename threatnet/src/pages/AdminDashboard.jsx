...
export default function AdminDashboard() {
  ...
  const fetchModelMetrics = async () => {
    try {
      const res = await authAxios.get(`${import.meta.env.VITE_FASTAPI_BASE || ""}/api/model/metrics`);
      setModelMetrics((m) => ({
        ...m,
  ...
  const triggerRetrain = async () => {
    ...
    try {
      await authAxios.post(`${import.meta.env.VITE_FASTAPI_BASE || ""}/api/model/retrain`);
    } catch (e) {
